...
describe("Cart Methods", () => {
  ...
  test("addToCart() should add a car object tot he cart array", () => {
  ...
  test("addToCart() should increate the total property", () => { 
    cart.addToCart(cars[0])
  ...
  test('removeFromCart() should remove a car object form the cart array', () => {
    cart.addToCart(cars[0])
    cart.addToCart(cars[1])
    cart.addToCart(cars[2])
